//
//  prUsersafety_ActivateAccount.swift
//  TheGame
//
...
class prUsersafety_ActivateAccount
{
                        ...
                        , json: String)
    {
        ...
        if(retCode as String == "AJAX_SERVICE_CONTROL_KEY_NOT_VALID"
            ...
            || retCode as String == "GAMER_ACTIVATION_NOT_COMPLETED")
        {
            NSLog("Successful Call 01:" + retCode);
        }
        else if(retCode as String == "GAMER_ACTIVATION_COMPLETED")
        {
            NSLog("Successful Call 02:" + retCode);
            vc.performSegueWithIdentifier("idsegueUsersafety_ActivateAccountSent", sender: vc);
        }
        else
        {
            NSLog("Bad Call");
    ...
    func getPostQueryString(email: NSString) -> String
    {
        ...
        var post:NSString = "AJAX_SERVICE_CONTROL_KEY=ACTIVATE_GAMER_ACCOUNT";
