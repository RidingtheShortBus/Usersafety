//
//  prUsersafety_LoginResetPassword.swift
//  TheGame
//
...
class prUsersafety_LoginResetPassword
{
        ...
        , json: String)
    {
        ...
        else if(retCode as String == "RESET_PASSWORD_COMPLETED")
        {
            ...
            vc.performSegueWithIdentifier("idsegueUsersafety_LoginResetPasswordSent", sender: vc);
        }
        else
        {
            NSLog("Bad Call");
